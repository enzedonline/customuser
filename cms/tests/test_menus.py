...
from ..models import *
from ..templatetags.cms_tags import *
...
class TestMenus(TestCase):
    ...
    def setUpTestData(cls):
        ...
        print (cls.foreign_language_code)
    ...
    def test_menuitem_trans_page_for_canonical_language(self):
        self.assertEqual(self.menuitem_articlepage1.trans_page(settings.LANGUAGES[0][0]).url, self.articlepage1.url)
